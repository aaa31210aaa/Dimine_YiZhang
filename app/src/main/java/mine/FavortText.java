...
public class FavortText extends TextView {
    private int itemColor;
    private int itemSelectorColor;
    private List<FavortBean> datas;
    ...
    public FavortText(Context context) {
        super(context);
    }

    public FavortText(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttrs(attrs);
    }

    public FavortText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public List<FavortBean> getDatas() {
        return datas;
    }

    public void setDatas(List<FavortBean> datas) {
        this.datas = datas;
