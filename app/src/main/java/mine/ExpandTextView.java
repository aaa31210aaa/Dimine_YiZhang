...
public class ExpandTextView extends LinearLayout {
    ...
    private void initView() {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.layout_full_text, this);
    ...
    public void setText(final CharSequence content) {
        ...
        contentText.setMovementMethod(new CircleMovementMethod(getResources().getColor(R.color.text_select_color)));
    }
