...
import com.example.administrator.dimine_yizhang.CommentDetail;
...
//  public static LinearLayout digCommentBody;
    ...
    public TestAdapter(Context context, List<Circle> mlist, Map<Integer, String[]> imageMap) {
...
//        });
        ...
        comment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("headimg",bean.getHeadimage());
                intent.putExtra("username",bean.getUsername());
                intent.putExtra("content",bean.getContent());
                intent.putExtra("images",imageMap.get(position));
                intent.putExtra("time",bean.getSendTime());
